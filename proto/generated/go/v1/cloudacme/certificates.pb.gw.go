...
/*
Package cloudacme is a reverse proxy.
...
func request_Certificates_Issue_0(ctx context.Context, marshaler runtime.Marshaler, client CertificatesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IssueCertificateRequest
...
func local_request_Certificates_Issue_0(ctx context.Context, marshaler runtime.Marshaler, server CertificatesServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq IssueCertificateRequest
	var metadata runtime.ServerMetadata
...
func RegisterCertificatesHandlerServer(ctx context.Context, mux *runtime.ServeMux, server CertificatesServer) error {
	...
	mux.Handle("POST", pattern_Certificates_Issue_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/cloudacme.v1.Certificates/Issue", runtime.WithHTTPPathPattern("/rpc/v1/certificates/issue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Certificates_Issue_0(ctx, inboundMarshaler, server, req, pathParams)
		...
		forward_Certificates_Issue_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterCertificatesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client CertificatesClient) error {
	...
	mux.Handle("POST", pattern_Certificates_Issue_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/cloudacme.v1.Certificates/Issue", runtime.WithHTTPPathPattern("/rpc/v1/certificates/issue"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Certificates_Issue_0(ctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Certificates_Issue_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"rpc", "v1", "certificates", "issue"}, ""))
)

var (
	forward_Certificates_Issue_0 = runtime.ForwardResponseMessage
)
