...
type OLDCertificatesUseCase interface {
...
var _ OLDCertificatesUseCase = (*oldCertificatesUseCase)(nil)

type oldCertificatesUseCase struct {
	vaultRepo       repository.VaultRepository
	letsencryptRepo repository.LetsEncryptRepository
}

// nolint: ireturn
func NewOLDCertificatesUseCase(certificatesRepo repository.VaultRepository, letsencryptRepo repository.LetsEncryptRepository) OLDCertificatesUseCase {
	return OLDCertificatesUseCase(&oldCertificatesUseCase{
		vaultRepo:       certificatesRepo,
		letsencryptRepo: letsencryptRepo,
	})
}

func (uc *oldCertificatesUseCase) IssueCertificate(
	ctx context.Context,
